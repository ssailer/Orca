...
- (void) shipInfluxEvent:(fcio_event*)event config:(fcio_config*)config withTag:(int)tag withIndex:(int)index andChannel:(int)channel andListener:(int)listener_id;

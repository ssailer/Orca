...
- (void) fcioReadInThread:(ORDataPacket*)aDataPacket
{
    ...
    if ([self fcioOpen]) {
        ...
        fcioReadThreadRunning = NO; // TODO: check what happens with runFailed and if the cleanup is proper, then we might not need setting fcioReadThreadRunning here
        [self runFailed];
    }
